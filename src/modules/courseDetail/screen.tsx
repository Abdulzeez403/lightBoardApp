    ...
    <SafeAreaView style={styles.container}>
      <View>
        ...
        >
          <View
            ...
            className=""
          >
            <Text className="bg-yellow-300 text-yellow-600 rounded-lg px-2">
              Best Selling
            </Text>
          ...
          <View>
            <Text className="text-center font-bold" style={{ fontSize: 25 }}>
              {course?.title}
            </Text>
          </View>
          <View style={{ flexDirection: "row", gap: 14 }}>
            <Components1
              icon={<ApIcon type="MaterialIcons" name="person" size={22} />}
              title={course?.instructor}
            />
            <Components1
              icon={<ApIcon type="AntDesign" name="playcircleo" size={22} />}
              title="23 Lessons"
            />
            <Components1
              icon={<ApIcon type="FontAwesome" name="certificate" size={22} />}
              title="Certification"
            />
          </View>
      ...
      {enrollStudent ? null : (
        <View style={styles.stickyButtonContainer} className="z-10">
          <ApButton label="Enroll Now" onPress={() => handleEnrollment()} />
        </View>
      )}
    </SafeAreaView>
  );
