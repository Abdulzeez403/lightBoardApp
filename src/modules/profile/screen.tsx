...
const ProfileScreen = () => {
  ...
  const ProfileList = ({ icon, title }: IProps) => (
    <View
      className="p-8 shadow-lg shadow-slate-400 rounded-md flex justify-center items-center"
      style={{ width: 170, height: 170 }}
    >
      <View className="text-center bg-blue-200 p-4 rounded-full">{icon}</View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View className="flex-1 items-center m-0 mt-10">
        <View
          style={{ width: 350, paddingVertical: 15 }}
          className="py-5 shadow-lg shadow-slate-400"
        >
        ...
        <View>
          <ApButton onPress={handleSignOut} label="SignOut" />
        </View>
      </View>
    </SafeAreaView>
  );
