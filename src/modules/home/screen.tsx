...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <View>
          <Text style={theme.fonts.H1}>Welcome, {user?.firstName}</Text>

          <Text
            className="mt-[-5px]"
            style={{
              color: "white",
              fontFamily: theme.fonts.Montserrat_500Medium.fontFamily,
              fontSize: 12,
            }}
          >
        ...
        <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
          ...
          <View>
            <RoundedImage
              source={require("../../../assets/studentAvatar.jpeg")}
              width={30}
              height={30}
            />
          </View>
      ...
      <ScrollView showsHorizontalScrollIndicator={false}>
        <View style={{ backgroundColor: "white" }}>
          <View
            ...
            className="justify-between items-center m-0 px-3"
          >
            <Text className="text-lg font-semibold my-2">Categories</Text>
            <TouchableOpacity
              className="bg-blue-200 rounded-lg py-1 px-2 "
              style={{ flexDirection: "row" }}
            >
            ...
            <View style={{ flexDirection: "row", justifyContent: "center" }}>
              {buttons.map((b, index) => (
                <View style={{ paddingHorizontal: 10 }} key={index}>
                  ...
                  >
                    <View
                      className="rounded-full justify-center items-center hover:bg-blue-300 hover:text-white shadow-md shadow-slate-300 bg-blue-300"
                      style={{
                        height: 60,
                        width: 60,
                        justifyContent: "center",
          ...
          <View style={{ paddingHorizontal: 10, paddingTop: 5 }}>
            <View
              style={{ flexDirection: "row" }}
              className="justify-between items-center m-0"
            >
